...
const page = () => {
  ...
  return (
    <main className="max-w-[100vw] ">
      ...
      {/* section 1 */}
      <section className="font-plus-jakarta-sans flex flex-col items-center justify-center gap-10 text-base w-11/12 md:max-w-[50%] mx-auto   text-[#6B7280] pt-7 pb-12 md:py-32 text-center ">
        <p className="font-plus-jakarta-sans  text-base   leading-link-text italic text-[#6B7280] text-center ">
          <span className="text-3xl font-bold ">"</span> Real estate is as
          intriguing an opportunity as they comes and in parallel, as complex as
          it could be in view of envisioning and then developing a masterpiece
          to creating a landmark. Investment in land represents an enormous
          opportunity when it is developed and as far as the location goes,
          there is no better piece of land than that which is abutting the curve
          of the river to then becoming a home that is for the discerning, the
          affluent and for those that finally want to call it home. This is
          Riverdale <span className="text-3xl font-bold">"</span>
        </p>
        <div>
      ...
      <section className="md:hidden   w-11/12 mx-auto space-y-12 mb-20">
        <div className="flex gap-2 items-center">
          ...
          <h1 className=" text-mob-banner-heading md:text-[30px] font-plus-jakarta-sans">
            OUR PROJECTS
          </h1>
        </div>
        <div className="space-y-20">
          {projectList?.map((project, idx) => (
            <div key={idx} className="space-y-7">
              <h1 className="text-mob-heading font-medium">{project.type}</h1>
